...
let expName = 'MGSblock3-final';  // from the Builder filename that created this script
...
function experimentInit() {
  ...
  demoStartResp = new visual.TextStim({
    win: psychoJS.window,
    name: 'demoStartResp',
    text: 'At the end of the delay, a white\ncircle will apear over the fixation:\n',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0], height: 0.03,  wrapWidth: undefined, ori: 0,
    color: new util.Color('white'),  opacity: 1,
